function camxes_preprocessing(input) {
	...
	// --- //
	input = input.replace(/[áàâä]/g,"à");
	input = input.replace(/[éèêë]/g,"è");
	input = input.replace(/[íìîïĭị]/g,"ì");
	input = input.replace(/[óòôö]/g,"ò");
	input = input.replace(/[úùûüŭụw]/g,"ù");
	input = input.replace(/[ýỳŷÿ]/g,"ỳ");
	// --- //
